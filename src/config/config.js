...
const envVarsSchema = Joi.object()
  .keys({
    ...
    JWT_REFRESH_EXPIRATION_DAYS: Joi.number().default(5).description("Days after which refresh token expires"),
    ...
    EMAIL_FROM: Joi.string().email().description("The from field in the emails sent by the app"),
  })
  .unknown();
